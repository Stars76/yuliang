...
import codex from '../server/providers/codex.js';
import codexDirect from '../server/providers/codex-direct.js';
import ollama from '../server/providers/ollama.js';
import commandCode from '../server/providers/command-code.js';
import opencodeGo from '../server/providers/opencode-go.js';
import kimi from '../server/providers/kimi.js';
import zai, { bigmodel } from '../server/providers/zhipu.js';
import deepseek from '../server/providers/deepseek.js';
import sub2api from '../server/providers/sub2api.js';
import newapi from '../server/providers/newapi.js';
